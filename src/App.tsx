  ...
  return (
    <main className="app-shell">
      ...
      <footer className="app-footer">
        <a href="https://github.com/toblum/HOmie" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" className="github-icon">
